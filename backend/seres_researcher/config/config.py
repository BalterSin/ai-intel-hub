...
from seres_researcher.llm_provider.generic.base import ReasoningEfforts
from .variables.default import DEFAULT_CONFIG
from .variables.base import BaseConfig
from ..search_tools.utils import get_all_retriever_names


class Config:
    """Config class for Seres Researcher."""
    ...
    def parse_llm(llm_str: str | None) -> tuple[str | None, str | None]:
        ...
        from seres_researcher.llm_provider.generic.base import _SUPPORTED_PROVIDERS
    ...
    def parse_embedding(embedding_str: str | None) -> tuple[str | None, str | None]:
        ...
        from seres_researcher.memory.embeddings import _SUPPORTED_PROVIDERS
