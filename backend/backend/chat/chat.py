...
from seres_researcher.utils.llm import get_llm
from seres_researcher.memory import Memory
from seres_researcher.config.config import Config
...
class ChatAgentWithMemory:
    ...
    async def chat(self, message, websocket):
        ...
        message = f"""
         You are Seres Researcher, a autonomous research agent created by Seres Automobile Co., Ltd.
         
         This is a chat message between the user and you: Seres Researcher. 
